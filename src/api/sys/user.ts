...
import { LoginParams,WxLoginParams, LoginResultModel, GetUserInfoModel } from './model/userModel';
...
export function wxLoginApi(params: WxLoginParams, mode: ErrorMessageMode = 'modal') {
  return defHttp.post<LoginResultModel>(
    {
      url: Api.WxLogin,
      params,
